...
int main(int argc, char** argv)
{
    ...
    gen_dim_jsonSolve<Mat,Vec>(argc, argv);
    //gen_dim_jsonSolve_extended<Mat,Vec>(argc, argv);
    //gen_dim_jsonSolve_compare_parallel<Mat,Vec>(argc, argv);
    return 0;
}
