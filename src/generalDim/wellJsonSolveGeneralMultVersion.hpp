...
#ifndef OPM_WELLJSONSOLVEGENERAL_HEADER_INCLUDED
#define OPM_WELLJSONSOLVEGENERAL_HEADER_INCLUDED

#endif

template<class Mat, class Vec>
void gen_dim_well_jsonSolve_mult_v2(std::vector<std::string> systemDirs)
{
